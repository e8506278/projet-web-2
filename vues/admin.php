...
<body>
    <section class="section-wrapper">
        <div class="row">
            <div class="card col-md-6 col-lg-3 mb-4 mb-lg-0 bg-revision">
            ...
            <div class="card col-md-6 col-lg-3 mb-4 mb-lg-0 bg-usager">
            ...
            <div class="card col-md-6 col-lg-3 mb-4 mb-lg-0 bg-cellier">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
            ...
            <div class="card col-md-6 col-lg-3 mb-4 mb-lg-0 bg-bouteille">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        ...
        <div class="row liste-wrapper">
            ...
            <div class="col-md-12 table-wrapper">
                ...
                <p class="err">Aucune information trouvée</p>
            </div>
        </div>
    </section>
