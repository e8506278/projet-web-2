...
<div class="detail-container">
    <table>
        ...
        <tbody id="detail-body">
            ...
            <tr>
                <td class="pa-8">Nom commun</td>
                <td>
                    <input type="text" name="nom_commun" <?= $disabled ?> value="<?php if (isset($vinoDetail) && isset($vinoDetail["nom_commun"])) echo $vinoDetail["nom_commun"]; ?>"></input>
                </td>
            </tr>
        </tbody>
    </table>
