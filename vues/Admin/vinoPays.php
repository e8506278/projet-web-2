...
<div class="detail-container">
    <table>
        ...
        <tbody id="detail-body">
            ...
            <tr>
                <td class="pa-8">Producteur de vin</td>
                <td>
                    <input type="text" name="producteur" <?= $disabled ?> value="<?php if (isset($vinoDetail) && isset($vinoDetail["producteur"])) echo $vinoDetail["producteur"]; ?>"></input>
                </td>
            </tr>
        </tbody>
    </table>
