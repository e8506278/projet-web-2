    ...
    <section class="section-wrapper carte carte--bg-couleur">
        <div class="recherche-wrapper">
            <div class="rechercher-action">
                ...
                <button class="bouton bouton-secondaire" title="Vider tous les champs">Réinitialiser</button>
            </div>
            <div class="rechercher-detail">
                <button class="accordeon accordeon-flex">
                    <div class="nb-mes-celliers nb-selectionnes">0</div>
                    ...
                    <div class="filtre-listbox">
                        <div class="filtre-entete">
                            <div class="filtre-entete-checkbox">
                                <input type="checkbox" id="mes-celliers-tous" data-js-mes-celliers-tous>
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-bouteille nb-selectionnes">0</div>
                    <div>Bouteilles</div>
                </button>
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-pays nb-selectionnes">0</div>
                    <div>Pays</div>
                </button>
                <div class="acc-container" data-js-hauteur="77">
                    <div class="filtre-autocomplete">
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-region nb-selectionnes">0</div>
                    <div>Régions</div>
                </button>
                <div class="acc-container" data-js-hauteur="77">
                    <div class="filtre-autocomplete">
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-appellation nb-selectionnes">0</div>
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-cepage nb-selectionnes">0</div>
                    <div>Cépages</div>
                </button>
                <div class="acc-container" data-js-hauteur="77">
                    <div class="filtre-autocomplete">
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-classification nb-selectionnes">0</div>
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-designation nb-selectionnes">0</div>
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-type-vin nb-selectionnes">0</div>
                ...
                <div class="acc-container">
                    <div class="filtre-listbox">
                        <div class="filtre-entete">
                            <div class="filtre-entete-checkbox">
                                <input type="checkbox" id="type-vin-tous" data-js-type-vin-tous>
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-type-cellier nb-selectionnes">0</div>
                ...
                <div class="acc-container">
                    <div class="filtre-listbox">
                        <div class="filtre-entete">
                            <div class="filtre-entete-checkbox">
                                <input type="checkbox" id="type-cellier-tous" data-js-type-cellier-tous>
                                <label for="type-cellier-tous">Tous</label>
                            </div>
                        </div>
                ...
                <button class="accordeon accordeon-flex">
                    <div class="nb-produit-qc nb-selectionnes">0</div>
                ...
                <div class="acc-container">
                    <div class="filtre-listbox">
                        <div class="filtre-entete">
                            <div class="filtre-entete-checkbox">
                                <input type="checkbox" id="produit-qc-tous" data-js-produit-qc-tous>
                                <label for="produit-qc-tous">Tous</label>
                            </div>
                        </div>
