    ...
    <div class="carte">
        ...
        <div class="carte__contenant" >
            ...
            if($data){
                ...
                <ul class="carte__lien--largeur carte--flex" data-js-carte>  
                    ...
                    <a class="carte__lien carte__lien--largeur" href="?requete=listeBouteilleCellier&id_cellier=<?php echo $cellier["id_cellier"];?>&nom_cellier=<?php echo $cellier["nom_cellier"];?>">
                        <li class="carte__contenu ">
                            ...
                            <div class="carte--flex carte__titre ">
                                ...
                                <!--ICONE type cellier-->
                                <div class="carte--flex " data-js-type>
                            ...
                            <ul class="carte__liste">
                                ...
                                <li class="carte__detail carte__detail-info">
                                    ...
                                    <div class="carte__detail ">
                                        ...
                                        <p class="carte__texte carte__texte--esg">
                                            <?php $total = intval($cellier['prix_total'])*intval($cellier['bouteille_total']); echo round($total,2);?>$<?php };?>
                                        </p>
                                    </div>
                                </li>
	...
	<div class="modal__contenu" data-js-modalcontenu data-js-usager="<?php echo $_SESSION['utilisateur']['id'];?>">
        ...
        <div class="formulaire__champs">
            ...
            <label class="radio"> Cellier 
                <input type="radio" class="carte__radio-btn" name="type_cellier_id" value="1">
            ...
            <label class="radio"> Réfrigérateur
                <input type="radio" class="carte__radio-btn" name="type_cellier_id" value="2">
