...
<section class="section-wrapper texte-photo">
	...
	<article class="texte-photo__contenu d-flex">
        ...
        <div class="product-photo">
            <img  src="https://www.saq.com/media/catalog/product/1/1/11097101-1_1580612720.png?quality=80&fit=bounds&height=166&width=111&canvas=111:166&dpr=2" alt="degustation2">
        </div>
...
<!--                </p>-->
<!--                <h2 class="price">-->
<!--                    --><?php //echo $product['prix_saq']?><!-- $-->
<!--                </h2>-->
<!--            </div>-->
<!--            <hr class="separator" />-->
<!--            <div class="row">-->
<!--                <p class="quantity col-6 normal-text">-->
<!--                    <i class="fa fa-check" aria-hidden="true"></i>-->
<!--                    <b>103</b> disponible(s) en ligne **HC**-->
<!--                </p>-->
<!--            </div>-->
<!--            <div class="row">-->
<!--                <div class="fieldset fieldset-qty-tocart margin-column-10 col">-->
<!--                    <div class="field qty">-->
<!--                        <div class="control">-->
<!--                            <input type="number" name="qty" id="qty" value="1" class="input-text ">-->
<!--                        </div>-->
<!--                    </div>-->
<!--                    <div class="actions">-->
<!--                        <button type="submit" title="Ajouter à la liste d'achat"-->
<!--                                class="bouton-secondaire" id="product-addtocart-button">-->
<!--                            <span>Ajouter à la liste d'achat</span>-->
<!--                        </button>-->
<!--                    </div>-->
<!--                </div>-->
<!---->
...
<!--                        <button type="submit" title="Ajouter à la liste d'achat"-->
<!--                                class="bouton-secondaire" id="product-addtocart-button">-->
<!--                            <span>Ajouter à mon cellier</span>-->
<!--                        </button>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
<!--            <hr class="separator" />-->
<!--            <h4>Choisir un cellier</h4>**HC**-->
<!--            <div class="cellier bouton-primaire">-->
...
<!---->
<!--            <hr class="separator" />-->
<!--            <p class="normal-text action margin-column-10">-->
                ...
                <div class="col-6 info-unit">
                    ...
                    <div class="value">
                        <input type="number"
                               ...
                               placeholder="Saisir le prix ici"/>
                    </div>
                </div>
                <div class="col-6 info-unit">
                    ...
                    <div class="value">
                        <input type="number"
                               min="0"
                               class="input formulaire__champs boite-double__champs"
                               placeholder="Saisir la quantité ici"/></div>
                </div>
            </div>
            <div class="row">
                <div class="col-6 info-unit">
                ...
                <div class="col-6 info-unit">
                    ...
                    <div class="value">
                        <input type="date"
                               class="input formulaire__champs boite-double__champs"
                               placeholder="Saisir la date d'achat ici"/>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-6 info-unit">
                    <div class="label">Choisir le cellier</div>
                    <div class="value">
                        <select class="input select formulaire__champs boite-double__champs">
                            <option>Celier 1</option>
                            <option>Celier 2</option>
                            <option>Celier 3</option>
                            <option>Celier 4</option>
                        </select>
                    </div>
                </div>
                <div class="col-6 info-unit">
                    ...
                    <div class="value">
                        <input type="text" class="input formulaire__champs boite-double__champs" placeholder="Saisir la millesime ici"/>
                    </div>
                </div>
            </div>
            <div class="row submit-bloc">
                <button class="bouton-primaire">Annuler</button>&nbsp;
                <button class="bouton-secondaire">Soumettre</button>
            </div>
		</div>
	</div>
</section>
