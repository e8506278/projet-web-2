            ...
            <a class="carte__lien" href="?requete=listeBouteilleCellier&id_cellier=<?php echo $cellier["id_cellier"];?>&nom_cellier=<?php echo $cellier["nom_cellier"];?>">
                <li class="carte__contenu ">
                    <div class="carte--flex carte__titre ">
                        ...
                        <div class="burger ">
                            <input class="burger__input" type="checkbox" id="<?php echo $cellier['id_cellier']; ?>">
                            <label for="<?php echo $cellier['id_cellier']; ?>"> 
                                ...
                                <ul class="burger__ouvre">
                                    <div class="carte--flex">
                                        <li><button data-js-modifiercellier class="burger__bouton-dropdown" href="?requete=monCellier&id_cellier=<?php echo $cellier["id_cellier"];?>"><i class="carte__icone--couleur-blanc"><svg class="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"> <path d="M362.7 19.32C387.7-5.678 428.3-5.678 453.3 19.32L492.7 58.75C517.7 83.74 517.7 124.3 492.7 149.3L444.3 197.7L314.3 67.72L362.7 19.32zM421.7 220.3L188.5 453.4C178.1 463.8 165.2 471.5 151.1 475.6L30.77 511C22.35 513.5 13.24 511.2 7.03 504.1C.8198 498.8-1.502 489.7 .976 481.2L36.37 360.9C40.53 346.8 48.16 333.9 58.57 323.5L291.7 90.34L421.7 220.3z"/></svg></i></button></li>
...
<div class="modal modal--ferme" data-js-modal>
	...
	<div class="modal__contenu" data-js-usager="<?php echo $_SESSION['utilisateur']['id'];?>">
        ...
        <div class="formulaire__champs">
            ...
            <input type="text" name="nom_cellier" value="<?php if($cellier) echo $cellier["nom_cellier"] ?>" required>
            <small class="carte__erreur" data-js-erreurnom></small>
        </div>
        <div class="formulaire__champs">
            <label class="radio"> Cellier 
                <input type="radio" name="type_cellier_id" value="1" <?php  if($cellier){
                     if($cellier["type_cellier_id"]=='1') {echo 'checked';}
                } ?>>
            ...
            <label class="radio"> Réfrigérateur
                <input type="radio" name="type_cellier_id" value="2" <?php  if($cellier){
                     if($cellier["type_cellier_id"]=='2') {echo 'checked';}
                } ?>>
        ...
        <div class="formulaire__champs">
            ...
            <input type="text" name="description_cellier" value="<?php if($cellier) echo $cellier["description_cellier"] ?>">
        </div>
        <!--Boutton--> 
        <div class="formulaire__champs">
